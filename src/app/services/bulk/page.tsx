...
export const metadata: Metadata = { title: "Bulk and Wholesale | Touch creations", description: "High-volume printing with best bulk pricing in Kenya." };
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-brand-950 py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="text-3xl font-medium text-brand-300">Bulk and Wholesale</h1>
          <p className="text-sm text-brand-600 mt-3">High-volume printing with best bulk pricing in Kenya.</p>
        </div>
      </div>
