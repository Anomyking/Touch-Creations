...
export const metadata: Metadata = { title: "Event Day Printing | Touch creations", description: "Last-minute event banners, programs, and signage." };
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-brand-950 py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="text-3xl font-medium text-brand-300">Event Day Printing</h1>
          <p className="text-sm text-brand-600 mt-3">Last-minute event banners, programs, and signage.</p>
        </div>
      </div>
