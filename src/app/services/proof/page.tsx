...
export const metadata: Metadata = { title: "Physical Proof Service | Touch creations", description: "Get a printed sample before your bulk order." };
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-brand-950 py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="text-3xl font-medium text-brand-300">Physical Proof Service</h1>
          <p className="text-sm text-brand-600 mt-3">Get a printed sample before your bulk order.</p>
        </div>
      </div>
