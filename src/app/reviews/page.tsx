...
export const metadata: Metadata = { title: "Customer Reviews | Touch creations", description: "What our customers say about Touch creations." };
    ...
    <div className="min-h-screen bg-white">
      <div className="bg-brand-950 py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="text-3xl font-medium text-brand-300">Customer Reviews</h1>
          <p className="text-sm text-brand-600 mt-3">What our customers say about Touch creations.</p>
        </div>
      </div>
